        ...
        <div className="grid min-h-screen items-center gap-12 py-4 md:py-24 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-8">
            ...
            <motion.h1
              ...
              className="max-w-4xl font-display text-4xl font-bold leading-tight text-text-dark sm:text-5xl lg:text-5xl xl:text-7xl"
            >
          ...
          <motion.div
            ...
            className="relative h-[450px] xl:h-[700px] w-full"
          >
            <Scene />
          </motion.div>
        </div>
